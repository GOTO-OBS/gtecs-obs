...
class Target(Base):
    ...
    rank_decay : bool, optional
        ...
        (unless start_rank=None, can't increase from infinity)
        default = True
    weight : int, optional
    ...
    def current_rank(self):
        ...
        """
        if self.start_rank is not None and self.rank_decay:
    ...
    def current_rank(self):
        return case([(and_(self.start_rank.isnot(None), self.rank_decay.is_(True)),
