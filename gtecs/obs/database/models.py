...
class Target(Base):
    ...
    start_rank : int
        ...
        later Pointings have their rank increased by 10 for each completed Pointing
        generated by this Target (given by `Target.current_rank`)
    ...
    def completed(self):
        ...
        return ~exists().where(and_(Strategy.target_id == self.db_id,
                                    Strategy.finished == False  # noqa: E712
                                    ))
    ...
    def completed_at_time(self, time):
        return ~exists().where(and_(Strategy.target_id == self.db_id,
                                    Strategy.finished_at_time(time) == False  # noqa: E712
                                    ))
