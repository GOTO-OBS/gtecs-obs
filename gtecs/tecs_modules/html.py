...
def write_obs_flag_files(obs, now, observer, debug):
    ...
    with open(flag_filename,'w') as f:
        ...
        if debug == 1:
            ...
            altaz_now = obs.altaz(now, observer.location)

            f.write('alt_now = ' + str(altaz_now.alt) + '<br>\n')
            f.write('az_now = ' + str(altaz_now.az) + '<br>\n')

            altaz_later = obs.altaz(later, observer.location)

            f.write('alt_mintime = ' + str(altaz_later.alt) + '<br>\n')
            f.write('az_mintime = ' + str(altaz_later.az) + '<br>\n')
